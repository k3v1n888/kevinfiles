...
class SyncData(ConsumerProcessorBase):
    ...
    def __init__(self, splunk_setting=None):
        ...
        :param splunk_setting:
            {
                "host": "localhost",
                "port": 8088,
                "token": "f4d112f1-20d4-4d34-b059-4d0376e734a8",
                'https': True,              # optional, bool
                'timeout': 120,             # optional, int
                'ssl_verify': False,         # optional, bool
        ...
        self.r.verify = self.option.get("ssl_verify", False)
...
def get_option():
    ...
    cursor_start_time = "2020-05-12 11:00:00"
